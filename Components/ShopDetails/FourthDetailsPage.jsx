    ...
    return (
        <View style = {styles.container}>
                ...
                <View style = {styles.DetailsView}>
                  ...
                  <Text style= {styles.ProductNameText}>Red Velvet Jacket</Text>
                 ...
                 <View style = {styles.SizesView}>
                  ...
                  <View><Text style = {styles.sizesCurrent}>S</Text></View>  
                ...
                <View style = {styles.PriceCartView}>
                  <View>
                      ...
                      <Text style={styles.totalPrice}>$115</Text>
                  </View>
...
export default FourthDetailsPage;
